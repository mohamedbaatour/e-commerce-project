...
mongoose.connect(
  "mongodb+srv://mohamedbaatour2009:mohamed@cluster0.otjsdyr.mongodb.net/"
);
...
app.post("/addtohistory", fetchUser, async (req, res) => {
  ...
  await Users.findOneAndUpdate(
    { _id: req.user.id },
    {
      $set: {
        orderHistory: [
          ...Object.entries(userData.orderHistory),
...
app.post("/getorderhistory", fetchUser, async (req, res) => {
